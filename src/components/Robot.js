...
const Robot = (props) => {
    var rotationen = Math.round(props.rotation.rotation*180/Math.PI)+270
    ...
    const listItems = alerts.map((number) => 
        <div key={number}
            style= {{
                position: "absolute",
                left: `${-12 + props.pos.x/props.pos.robotScale}px`,
                top: `${props.pos.map_size_y - 18 - props.pos.y/props.pos.robotScale}px`
            }}
        >
