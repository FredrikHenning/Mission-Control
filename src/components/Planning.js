    ...
    return(
        ...
        <TransitionGroup>
            <div key={"2"} style={{ display: "inline-block", padding: 2}}>
                <PlanningStartCard progress={ProgressbarValue} callback={handleProgressBar} planscounter={planscounter} totalnrplans ={7} name={"finished"} list={PlansObjList}/>   
            </div>
            {Plans}
            <div key={"1"} style={{ display: "inline-block", padding: 2}}>
                <PlanningStartCard progress={ProgressbarValue} callback={handleProgressBar} planscounter={planscounter} totalnrplans ={7} name={"more"} list={PlansObjList}/>   
            </div>
        </TransitionGroup>  
        </Box>
